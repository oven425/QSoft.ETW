...
namespace QSoft.ETW
{
    public static partial class ETW
    {
        ...
        [LibraryImport("KernelTraceControl.dll", EntryPoint = "StartKernelTrace", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.U4)]
        internal static partial uint StartKernelTrace(out IntPtr TraceHandle, IntPtr Properties, uint cStackTracingEventIds);


        [LibraryImport("KernelTraceControl.dll", EntryPoint = "StartKernelTrace", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.U4)]
        internal unsafe static partial uint StartKernelTrace(out IntPtr TraceHandle, byte* Properties, uint cStackTracingEventIds);
